class HingesManager {
    constructor({svg, guiFolder, dihedralAngles, facesSidesAmounts, hingesAmounts}) {
        ...
        this.clones = document.createElementNS(SVG_NS,'g')
    ...
    doCloneHinge(hinge, cloneAmount) {
        // console.log('cloneAmount: ', cloneAmount);
        const margin = this.margin;
        const columns = this.columns;
        var actualAmount = cloneAmount / 2 | 0;
        // console.log('actualAmount: ', actualAmount);
        const cloneTx = hinge.cloneTx;
        // console.log('cloneTx: ', cloneTx);
        const cloneTy = hinge.cloneTy;
        // console.log('cloneTy: ', cloneTy);
        // const margin = 10;
        // console.log('margin: ', margin);

        for (let index = 1; index < actualAmount; index++) {
            const qiece = hinge.original.cloneNode(true);
